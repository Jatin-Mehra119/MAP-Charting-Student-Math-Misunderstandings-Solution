...
trainer = Trainer(
    ...
    # eval_dataset=val_ds,  # Remove evaluation dataset
    processing_class=tokenizer,
    # compute_metrics=compute_map3,  # Remove metrics computation
...
trainer.save_model(f"/content/drive/MyDrive/map-charting-student-math-misunderstandings/qwen3_14b/best")
joblib.dump(le, f"/content/drive/MyDrive/map-charting-student-math-misunderstandings/qwen3_14b/label_encoder.joblib")