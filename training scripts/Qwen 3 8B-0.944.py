...
trainer.save_model(f"/content/drive/MyDrive/map-charting-student-math-misunderstandings/qwen3-8B/best") 
joblib.dump(le, f"/content/drive/MyDrive/map-charting-student-math-misunderstandings/qwen3-8B/label_encoder.joblib")
